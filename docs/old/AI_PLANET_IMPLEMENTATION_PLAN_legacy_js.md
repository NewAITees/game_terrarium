# AI惑星戦略箱庭 実装プラン - legacy JS layout

This archive preserves the older JavaScript-era module layout that was used
before the `planet_strategy` codebase was split into TypeScript modules.
