...
この一覧には、**2026-06-09 時点で未完または再調整が必要な項目だけ**を残す。
...
- [x] 崩壊帝国の残存船除去（崩壊時に ship mesh と `world.ships` から削除）
- [x] 枯渇星の視覚改善（size=1.5、ownership ring 維持、ore ring 非表示）
- [x] 工場アイコン表示（上方アイコン、HP 連動点滅/縮小）
