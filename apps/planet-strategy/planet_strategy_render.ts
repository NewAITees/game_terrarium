...
export function createPlanetStrategyRenderer({
  ...
  function attachShipMesh(ship: PlanetStrategyShip, empire: PlanetStrategyEmpire): void {
  ...
  function removeShipMesh(ship: PlanetStrategyShip): void {
    if (ship.trailLine) {
  ...
  function ensureRouteVisual(route: PlanetStrategyRoute): void {
...
function lerpPlanet(a: PlanetStrategyPosition, b: PlanetStrategyPosition, t: number): PlanetStrategyPosition {
  return {
    x: a.x + (b.x - a.x) * t,
