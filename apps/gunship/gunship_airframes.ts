...
export type Airframe = { id: AirframeId; label: string; blurb: string; thrust: number; turn: number; thrustTurnK: number; drag: number; maxHp: number };

export const AIRFRAMES: readonly Airframe[] = [
  { id: 'interceptor', label: 'INTERCEPTOR', blurb: '軽量万能・基準機。ジレンマが最も穏やか', thrust: 408, turn: 2.9, thrustTurnK: .6, drag: .32, maxHp: 100 },
  { id: 'hauler', label: 'HAULER', blurb: '重量ガンシップ・低TWR。貯めて一度に薙ぐ', thrust: 344, turn: 2.15, thrustTurnK: .4, drag: .42, maxHp: 132 },
  { id: 'darter', label: 'DARTER', blurb: '高速一撃離脱・低抵抗。止まれない', thrust: 459, turn: 2.6, thrustTurnK: .5, drag: .2, maxHp: 86 },
  { id: 'hoverer', label: 'HOVERER', blurb: '低推力精密・高旋回。最も落ちやすい', thrust: 331, turn: 3.25, thrustTurnK: .68, drag: .44, maxHp: 92 },
] as const;
