...
function buildPrompt(digest: LedgerDigest): string {
  ...
  return [
    ...
    '  {"kind":"spec","spec":{"learnerVariant":"...","observation":"...","actions":"...","reward":{"weights":{...}},"learner":{...}},"rationale":"..."}',
    ...
    '',
    `Declared learner variants: ${space.learnerVariants.join(', ')}`,
    ...
    JSON.stringify({
      ...
      learnerVariants: digest.learnerVariants,
